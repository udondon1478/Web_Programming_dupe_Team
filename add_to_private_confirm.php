...
<body>
    <div class="container">
        ...
        if ($dbh) {
            ...
            //$user_idに含まれるidを挿入、channel_idはGETで取得
            for ($i = 0; $i < $count - 1; $i++) {
                $sql = "INSERT INTO `channel_users_tb` (`channel_id`, `user_id`) VALUES ('" . $_GET['channel_id'] . "', '" . $user_id[$i] . "')";
                $dbh->exec($sql);
            }
            echo 'チャンネルにユーザーを追加しました';
        }
