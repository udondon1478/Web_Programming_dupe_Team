...
//チャンネルメンバー中間テーブルの作成
$sql = "CREATE TABLE `channel_users_tb`(`id` INT AUTO_INCREMENT PRIMARY KEY,`channel_id` INT NOT NULL,`user_id` INT NOT NULL,FOREIGN KEY (`channel_id`) REFERENCES `channel_tb`(`id`),FOREIGN KEY (`user_id`) REFERENCES `user_tb`(`id`));";
$dbh->exec($sql); //SQLの実行
echo "channel_users_tbを作成しました<br>";

//仮登録
$dbh->exec('SET foreign_key_checks=0;');
$sql = "INSERT INTO `channel_users_tb` (`channel_id`,`user_id`)
